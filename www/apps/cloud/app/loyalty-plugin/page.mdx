...
The Loyalty Plugin is an add-on to your Cloud projects that provides loyalty features. It adds modules, API routes, workflows, and admin customizations that provide loyalty-related features to your Medusa application.

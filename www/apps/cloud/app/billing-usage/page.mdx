...
This is useful if you want to make sure you're not exceeding your usage, understand your plan's offering, and manage your billing details.
...
Billing information are used in your organization's invoices. You can edit the billing information to make sure the invoices include the correct details.
...
- **Current plan**: The plan your organization is currently subscribed to and when is the next billing date.
- **Usage limits**: The usage limits for your current plan. The **Usage** column indicates how much your organization has used so far, and the **Included** column indicates the limits of your current plan. You'll mainly find two types of usage limits:
...
The payment may fail for various reasons, such as insufficient funds, expired card, or other issues with the payment method. So, make sure to [update your payment method](#manage-payment-method) if needed.

...
- A Cloud account with a valid plan that allows creating more projects.
    - If you've exceeded the number of projects limit for your plan, you can [contact our sales team to upgrade your plan](https://medusajs.com/contact).
...
To open the deployed Medusa Admin, click on the URL in the "Production" card of the project's dashboard. It will open the Medusa Admin in a new tab.
...
To open a project's dashboard, you need to be in the organization's dashboard where the project is located. Then, you can click on the card of the project you want to view.
...
3. **Production URL**: The URL of the project's production deployment. You'll find it in the "Production" card under the title. Clicking on it will open the production Medusa Admin in a new tab.
4. **Repository**: The GitHub repository linked to the project. You'll find it as a "Repository" button at the top right of the project's dashboard. Clicking on it will open the repository in a new tab.

...
- A Cloud account with a valid plan that allows creating more projects.
    - If you've exceeded the limit of projects for your plan, you can [contact our sales team to upgrade your plan](https://medusajs.com/contact).

#### Medusa Application Configurations

Your Medusa application doesn't need specific configurations to be deployed to Cloud. Cloud will automatically create the necessary [server and worker instances](!docs!/learn/production/worker-mode) for you. Cloud will also automatically take care of scaling your Medusa application's resources based on the traffic it receives.

In addition, Cloud automatically configures the following modules for your project with the necessary resources:
...
So, if you have any of these modules configured in your Medusa application, remove them from your `medusa-config.ts` file before deploying to Cloud. Cloud will automatically configure them for you.
...
6. In the next step, you'll need to configure the project's settings:
...
If you click on the project, you'll be taken to the project's dashboard, where you can view [its details and status](#view-project-details).
...
You can open the production deployment of the project by clicking on the URL in the Production section of the project's dashboard.
...
Clicking the production URL will open the Medusa Admin in a new tab. You can then log in using the email and password you set during the project creation.
...
If you encounter any issues while creating a project, here are some common troubleshooting steps:
...
You can open a project's dashboard from the organization's dashboard by clicking on the project in the list of projects. This will show the project's name at the top left next to the [organization switcher](../organizations/page.mdx#organization-switcher).
...
3. **Production URL**: The URL of the latest production deployment of the project. You'll find it under the "Production" title. Clicking on it will open the production Medusa Admin in a new tab.
4. **Repository**: The GitHub repository linked to the project. You'll find it as a button at the top right of the project's dashboard. Clicking on it will open the repository in a new tab.
...
The project's name at the top left of the dashboard is also a project switcher. To switch to a different project:
...
3. In the "General" tab, you can edit the project's name and root directory in the repository.
...
You can also edit the preview settings of a project from the "Settings" tab. Learn more in the [Environments documentation](#).
...
1. Open the project's dashboard.
2. Click on the "Settings" tab.
3. In the "General" tab, click the "Delete project" button.

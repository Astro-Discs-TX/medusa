...
Learn more about connecting your storefront to your Medusa server deployed on Cloud in the [Connect Production Storefront](./connect-storefront/page.mdx) guide.

### What resources does Cloud provide?

Cloud provides fully-managed resources like [PostgreSQL](./database/page.mdx), [Redis](./redis/page.mdx), and [S3](./s3/page.mdx). You don't need to configure or maintain them.

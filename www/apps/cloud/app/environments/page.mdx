...
An environment represents a stage of a [project](../projects/page.mdx)'s development, such as staging or production. Each environment has its own resources and configurations. For example, you can have Production and Staging environments.
...
It's recommended to create long-lived environments for different stages of your project.

...
As of [Medusa v2.1.4](https://github.com/medusajs/medusa/releases/tag/v2.1.4), Remote Link has been deprecated in favor of Link. They have the same usage, so you only need to change the key used to resolve the tool from the Medusa container as explained below.

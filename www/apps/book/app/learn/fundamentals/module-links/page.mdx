...
As mentioned in the [How Module Links are Stored](#module-links-database-table) section, the name of a link's table consists of the names of the modules and the data models' table names.

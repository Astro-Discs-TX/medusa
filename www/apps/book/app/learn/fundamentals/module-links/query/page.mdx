...
As of [Medusa v2.1.4](https://github.com/medusajs/medusa/releases/tag/v2.1.4), `remoteQueryConfig` has been depercated in favor of `queryConfig`. Their usage is still the same, only the property name has changed.

...
// Find multiple products with filtering
...
To learn about all the methods available in a data model repository, refer to the [Data Model Repository](!resources!/data-model-repository-reference) reference.
...
Here are examples of more complex SQL queries for common e-commerce needs:

```ts
// Get popular products with their categories

...
export const metadata = {
  title: `Integrate Medusa with Algolia`,
  openGraph: {
    images: [
      {
        url: ogImage,
...
In the storefront's `.env.local`, add the following Algolia-related environment variables:
...
- Add filters to the search results. You can do that using Algolia's [widgets](https://www.algolia.com/doc/guides/building-search-ui/widgets/showcase/react/). However, you'll need to customize the search API route to accept filter parameters.

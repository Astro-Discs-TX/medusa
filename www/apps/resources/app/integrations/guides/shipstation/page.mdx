...
In this method, you'll retrieve the shipment details from ShipStation, then use those details to purchase a label for a new shipment. You'll also store the ID of the label and shipment within the created fulfillment's `data` property.

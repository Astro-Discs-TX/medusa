...
In the route handler, you resolve the [Event Module](../../../architectural-modules/event/page.mdx)'s service from the Medusa container and emit the `products.sync` event.

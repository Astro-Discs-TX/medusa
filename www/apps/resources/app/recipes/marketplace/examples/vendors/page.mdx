...
The Medusa Admin is extendable, allowing you to add widgets to existing pages or create new pages. For example, you can add a new page showing the list of vendors. Learn more about it in [this documentation](!docs!/learn/fundamentals/admin).

The Medusa admin is only accessible by super admins, not your vendor admins. So, if you want a dashboard specific for each vendor admin, you'll have to build a custom dashboard based on the functionalities you want to provide.

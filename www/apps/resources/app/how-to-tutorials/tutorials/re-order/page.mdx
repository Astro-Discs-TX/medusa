...
export const metadata = {
  title: `Implement Re-Order Functionality in Medusa`,
  openGraph: {
    images: [
      {
        url: ogImage,
...
Medusa's Framework facilitates building custom features that are necessary for your business use case. In this tutorial, you'll learn how to implement a re-order functionality in Medusa.

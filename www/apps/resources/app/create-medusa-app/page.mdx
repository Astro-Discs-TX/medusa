  ...
  <Table.Body>
    ...
    <Table.Row>
      ...
      <Table.Cell>
        ...
        Create a [plugin project](#create-a-medusa-plugin-project) instead of a Medusa application. This option is available starting from [Medusa v2.2.1](https://github.com/medusajs/medusa/releases/tag/v2.2.1).

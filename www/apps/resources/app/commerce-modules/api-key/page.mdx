...
You can then execute the workflow in your cusotm API routes, scheduled jobs, or subscribers:
...
<CodeTabs group="resource-types">
  <CodeTab label="API Route" value="api-route">
    ...
    import myWorkflow from "../../workflows/create-api-key"
  ...
  <CodeTab label="Scheduled Job" value="scheduled-job">
    ...
    ```ts title="src/jobs/message-daily.ts" highlights={[["7"], ["8"]]}

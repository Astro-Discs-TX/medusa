...
const retrieveCurrencyStep = createStep(
  ...
  async ({}, { container }) => {
    ...
    return new StepResponse({ currency }, currency.id)
  }
)
...
export const retrievePriceWithCurrency = createWorkflow(
  "create-currency",
  (input: Input) => {
    const currency = await retrieveCurrencyStep()
...
<CodeTabs group="resource-types">
  ...
  <CodeTab label="Subscriber" value="subscriber">
    ...
    ```ts title="src/subscribers/customer-created.ts" highlights={[["11"], ["12"], ["13"], ["14"]]} collapsibleLines="1-6" expandButtonLabel="Show Imports"
    import {
  ...
  <CodeTab label="Scheduled Job" value="scheduled-job">
    ...
    ```ts title="src/jobs/message-daily.ts" highlights={[["7"], ["8"], ["9"], ["10"]]}
...
<CommerceModuleSections name="Currency" hideWorkflowsSection />
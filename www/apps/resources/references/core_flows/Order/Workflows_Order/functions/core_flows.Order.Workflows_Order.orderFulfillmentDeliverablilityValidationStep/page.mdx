...
const myWorkflow = createWorkflow(
  ...
  () => {
    const data = orderFulfillmentDeliverablilityValidationStep({
      "order": {
        "id": "id_8ti8Yzxl6Gr4PmFi37z",
        "version": 4,
        "display_id": 17,
        "status": "requires_action",
        "currency_code": "{value}",
        "created_at": "2025-07-25T02:28:49.539Z",
        "updated_at": "2025-10-20T12:27:24.796Z",
        "original_item_total": {
          "numeric": 8
        },
      ...
      "fulfillment": {
        ...
        "provider": {
          ...
          "shipping_options": [{
            ...
            "type": {
              "id": "id_phLWCu0XN6fDYtnY7s",
              "label": "{value}",
              "description": "Abeo deripio patrocinor delego nisi basium consectetur.",
              "code": "{value}",

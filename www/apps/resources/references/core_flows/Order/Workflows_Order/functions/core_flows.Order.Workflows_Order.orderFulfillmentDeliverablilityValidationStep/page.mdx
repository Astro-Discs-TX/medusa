  ...
  () => {
    const data = orderFulfillmentDeliverablilityValidationStep({
      "order": {
        ...
        "status": "canceled",
        "currency_code": "{value}",
        "created_at": "2025-11-25T17:46:23.638Z",
        "updated_at": "2025-07-10T10:15:12.897Z",
        "original_item_total": {
          "numeric": 44
        },
        ...
        "provider": {
          ...
          "shipping_options": [{
            ...
            "type": {
              "id": "id_4csoEPBEJb",
              "label": "{value}",
              "description": "Cogo audeo volubilis tum textor cupressus creo vereor illum nemo.",
              "code": "{value}",

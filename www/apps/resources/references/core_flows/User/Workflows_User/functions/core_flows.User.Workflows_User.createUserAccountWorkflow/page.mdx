...
<SourceCodeLink link="https://github.com/medusajs/medusa/blob/911eefadbd8280509f7bf89c1fa2e1b083c1d219/packages/core/core-flows/src/user/workflows/create-user-account.ts#L20" />
  ...
  const { result } = await createUserAccountWorkflow(req.scope)
    .run({
      input: {
        ...
        "userData": {
          "email": "Daphne_Greenholt@gmail.com"
        }
      }
    })

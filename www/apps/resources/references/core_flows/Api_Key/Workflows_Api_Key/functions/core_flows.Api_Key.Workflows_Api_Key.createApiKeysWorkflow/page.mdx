...
<SourceCodeLink link="https://github.com/medusajs/medusa/blob/911eefadbd8280509f7bf89c1fa2e1b083c1d219/packages/core/core-flows/src/api-key/workflows/create-api-keys.ts#L15" />
    ...
    .run({
      input: {
        "api_keys": [{
          "title": "quis",
          "type": "secret",
          "created_by": "user_Ij63csvQ09rzLm"
        }]
      }
    })
